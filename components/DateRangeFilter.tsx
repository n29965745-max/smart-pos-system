...
export default function DateRangeFilter({ 
  ...
  return (
    <div className="flex items-center gap-1 sm:gap-2">
      ...
      <div className="flex items-center gap-1 sm:gap-1.5 min-h-[44px] bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-lg px-2 sm:px-3 py-2">
        ...
        <input
          ...
          className="bg-transparent border-none text-xs sm:text-sm text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] focus:outline-none w-[70px] sm:w-[90px]"
        />
      </div>
      
      <span className="text-[var(--text-secondary)] text-[10px] sm:text-xs shrink-0 hidden sm:inline">to</span>
